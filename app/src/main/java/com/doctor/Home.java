...
public class Home extends Fragment /*implements TabLayout.OnTabSelectedListener*/{
    ...
    private static final Integer[] XMEN = {R.drawable.doc1, R.drawable.doc2, R.drawable.doc3, R.drawable.doc4};
   ...
   ViewPager mPager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Doctors Test");
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Videolist(), "Diseases Test");
       // adapter.addFrag(new Subscription(), "Premium");
