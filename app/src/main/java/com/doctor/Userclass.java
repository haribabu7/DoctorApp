...
*/
       ...
       /* viewPager = (ViewPager) findViewById(R.id.viewpager);
        ...
        View headerView = navigationView.inflateHeaderView(R.layout.nav_user_main);
        headerView.findViewById(R.id.linear);
        TextView update = (TextView) headerView.
                findViewById(R.id.userheader);
        Session sess=new Session(Userclass.this);
        String mailid=sess.getMailid();
        update.setText(mailid);
   ...
   fragment = new Home();
        ...
        {
          Intent intent=new Intent(Userclass.this,MainActivity.class);
